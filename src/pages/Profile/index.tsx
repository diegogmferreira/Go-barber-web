        ...
        try {
            ...
            const schema = Yup.object().shape({
                ...
                password: Yup.string().when('old_password', {
                    ...
                    then: Yup.string().required().min(6, 'No mínimo 6 dígitos obrigatória'),
            ...
            // Same const above but different way
            ...
            addToast({
                ...
                description: 'Ocorreu um erro ao atualizar os dados do perfil, tente novamente.'
            });
        };
